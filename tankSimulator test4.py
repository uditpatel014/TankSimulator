...
e1=entrybox(90,60,30,120)
e2=entrybox(200,170,150,120)
...
Startbutton = Button(root, text='START1', bd ='2', bg = 'IndianRed1',font =('Helvetica bold',10), command = lambda:[gogreen(t1),countdowntimer(e1[0],e1[1],e1[2])]).place(x=30, y=180)
Startbutton2 = Button(root, text='START2', bd ='2', bg = 'IndianRed1',font =('Helvetica bold',10), command = lambda:[gogreen(t2),countdowntimer(e2[0],e2[1],e2[2])]).place(x=200, y=180)
